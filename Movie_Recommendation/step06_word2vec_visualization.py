...
### 해당 키워드와 벡터 기준 가까운 단어들 찾기
key_word = '여름'
sim_word = embedding_model.wv.most_similar(key_word, topn=10)
print(sim_word)
# topn 키워드와 가장 가까이 배치된 단어 10개를 찾아줌(topN) / 벡터를 기준으로해서 가까운 단어들이 유사하다고 본다.
# 예시 ('무덥다', 0.7225126028060913), ('가을', 0.720637857913971) ...
...
print(vectors[0]) # 10개의 단어 중 첫번째 단어에 대한 100개의 벡터값
print(len(vectors[0]))
